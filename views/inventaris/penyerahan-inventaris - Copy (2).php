                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form>
                                            <div class="row">
                                                <div class="col-auto">
                                                    <select data-id="<?=$id?>" name="ruangan[]" class="form-control form-select room-select" style="display: none;">
                                                        <option value="">--- Pilih Ruangan ---</option>
                                                    </select>
                                                </div>
                                            </div>
                ...
                fetch(`app/controller/inventaris/get_rooms.php?unit=${encodeURIComponent(selectedUnit)}`)
                    ...
                    .then(data => {
                        if (Array.isArray(data) && data.length > 0) {
                            ...
                            roomSelect.style.display = 'none'; // Sembunyikan jika tidak ada data
                            const option = document.createElement('option');
                            option.value = '';
