...
$pdf->Cell(30,5,'Tgl Validasi',0,0);
$pdf->Cell(6,5,':',0,0);
$pdf->Cell(1,5,date("d M Y", strtotime($data_pengajuan['tgl_validasi'])),0,0);
...
$pdf->Cell(6,5,':',0,0);
$pdf->Cell(1, 5, $data_rkk['nama_rkk'] . ' ' . $data_rkk['unit_rkk'], 0, 0);
$pdf->Ln();
...
$pdf->SetXY($x+2, $y+15);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(25, 5, 'Mengetahui', 0, 0, 'C');
...
$rightX = 162;
$pdf->Image('../../../public/file/qr/' . $data_user['nopeg'] . '.png', $rightX, $y+25, 25, 25);

// tanggal
$pdf->SetXY($rightX-5, $y+20);
$pdf->Cell(35, 6, tgl_ind($today), 0, 0,'');  // 40 lebar, align center

// Nama
$pdf->SetXY($rightX, $y+52);
$pdf->Cell(25, 5, $data_user['nama'], 0, 0, 'C');
...
$pdf->Output("../../../public/file/keperawatan/permohonan/hasil-verifikasi-".$kode_pengajuan."-".$nopeg.".pdf", 'F');
