...
if (!empty($no_seri)) {
	...
	$no_seri_array = explode(',', $_POST['no_seri']);

	// Menghitung jumlah elemen
	$jumlah_data = count($no_seri_array);
	...
	if ($jumlah!=$jumlah_data) {

		$_SESSION['pesan'] = 'Jumlah No seri tidak sesuai dengan jumlah pembelian';
		$_SESSION['info'] = 'Gagal !';
