...
if (!in_array($file_ext, $allowed)) {
    $_SESSION['pesan'] = 'Berkas '.strtoupper($nama_data).' Tidak sesuai Format. Pastikan berformatkan gambar / pdf !';
	$_SESSION['info'] = 'Gagal Upload ! ';
	...
	if ($simpan_file_detail) {
		$jenis_transaksi ='upload';
		$keterangan_log = 'Berkas <strong>'.$jenis.'</strong> Berhasil diupload';
