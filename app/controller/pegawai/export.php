...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $sheet->setCellValueByColumnAndRow(2, $nomor_baris, $row['nopeg']); // NIP
        ...
        $sheet->setCellValueByColumnAndRow(5, $nomor_baris, $row['nik']); // NIK
        ...
        $sheet->setCellValueByColumnAndRow(15, $nomor_baris, $row['telpon']); // Nomor Telepon
