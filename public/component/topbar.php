...
<!-- Top Bar End -->
<!-- Top Bar End -->
<div class="modal fade" id="exampleModalDefaultmenu" tabindex="-1" role="dialog" aria-labelledby="exampleModalDefaultLabel" aria-hidden="true" data-bs-backdrop="false" data-bs-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <img src="<?=$link?>public/resources/assets/images/home.webp" style=" aspect-ratio: 1 / 1; width: 100%; max-width: 90px; height: auto; border-radius: 50%; object-fit: cover;" class="img" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <img src="<?=$link?>public/resources/assets/images/profil.webp" style=" aspect-ratio: 1 / 1; width: 100%; max-width: 80px; height: auto; border-radius: 50%; object-fit: cover;" class="img" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <a href="<?=$link?>upload-berkas">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-7 p-3">
                                            <center>
                                                <h3>Berkas Kepegawaian</h3>
                                            </center>
                                        </div>
                                        <div class="col-auto">
                                            <img src="<?=$link?>public/resources/assets/images/berkas.webp" style=" aspect-ratio: 1 / 1; width: 100%; max-width: 80px; height: auto; border-radius: 50%; object-fit: cover;" class="img" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <img src="<?=$link?>public/resources/assets/images/k&s.webp" style=" aspect-ratio: 1 / 1; width: 100%; max-width: 80px; height: auto; border-radius: 50%; object-fit: cover;" class="img" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-auto">
                                            <img src="<?=$link?>public/resources/assets/images/small/beranda.webp" style=" aspect-ratio: 1 / 1; width: 100%; max-width: 80px; height: auto;border-radius: 50%; object-fit: cover;" class="img" />
                                        </div>
                                    </div>
                                </div>
                            </div>
