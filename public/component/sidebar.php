<div class="leftbar-tab-menu">
    <div class="main-icon-menu">
        <a href="index.html" class="logo logo-metrica d-block text-center">
            <span>
                <img src="public/resources/assets/images/logo-sm.png" alt="logo-small" class="logo-sm">
            </span>
        </a>
        ...
        <div class="pro-metrica-end">
            <a href="" class="profile">
                <img src="public/resources/assets/images/users/user-4.jpg" alt="profile-user" class="rounded-circle thumb-sm">
            </a>
