                    ...
                    <div class="col-sm-12">
                        <table class="table table-sm">
                            ...
                            <tr>
                                <th>Jabatan</th>
                                <th>:</th>
                                <td><?=$pecah['jabatan']?> <a href="#" class="btn btn-primary btn-sm" id="btnTambah" name="btn_tmbh">Tambah</a></td>
                            </tr>
                            <tr id="formRow" style="display: none;">
                                <td colspan="3">
                                    <form method="post" action="proses.php" id="mainForm">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" id="btnBatal">Batal</button>
                                    </form>
                                </td>
                            </tr>
                            <tr>
...
<script>
        ...
        btnTambah.addEventListener("click", function(event) {
            ...
            // Jika form belum tampil, tampilkan form
            if (formRow.style.display === "none") {
                formRow.style.display = ""; // Tampilkan form
            } else {
                // Jika form sudah tampil, tambahkan input baru
