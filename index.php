...
<body id="body">
    ...
    <script src="<?=$link?>public/resources/assets/js/pages/datatable.init.js"></script>
     ...
     <script src="<?=$link?>public/resources/assets/libs/sweetalert2/sweetalert2.min.js"></script>
    <script src="<?=$link?>public/resources/assets/js/pages/sweet-alert.init.js"></script>

    <!-- Apex chart -->
     <script src="<?=$link?>public/resources/assets/libs/apexcharts/apexcharts.min.js"></script>
     <script src="<?=$link?>public/resources/assets/js/pages/apexcharts.init.js"></script>
